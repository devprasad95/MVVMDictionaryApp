...
import com.example.mvvmdictionaryapp.presentation.MainState
import com.example.mvvmdictionaryapp.presentation.MainUiEvents
import com.example.mvvmdictionaryapp.presentation.MainViewModel
                    ...
                    topBar = {
                        OutlinedTextField(
                            modifier = Modifier
                                .fillMaxWidth()
                                .padding(16.dp),
                            value = mainState.searchWord, onValueChange = {
        ...
        Box(
            ...
            Box(
                ...
                if (mainState.isLoading) {
                    ...
                    mainState.wordItem?.let { WordResult(wordItem = it) }
                }
            }
        }
    }
